...
public:
    DataFloat();
    DataFloat(const double *data_double, std::vector<std::string> variable_names, size_t num_rows, size_t num_cols);
    DataFloat(const float *data_float, std::vector<std::string> variable_names, size_t num_rows, size_t num_cols);
    virtual ~DataFloat();
    ...
    void set(size_t col, size_t row, double value, bool &error) { data[col * num_rows + row] = (float)value; }
